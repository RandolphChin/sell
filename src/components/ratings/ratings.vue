          ...
          <li v-for="rating in ratings" v-show="needShow(rating.rateType,rating.text)" class="rating-item">
            ...
            <div class="content">
              ...
              <div class="star-wrapper">
                ...
                <span class="delivery" v-show="rating.deliveryTime">{{rating.deliveryTime | time}}</span>
              </div>
              <p class="text">{{rating.text}}</p>
              <div class="recommend" v-show="rating.recommend.length">
                <span class='icon-thumb_up'></span>
                <span class="item" v-for="item in rating.recommend"></span>
              </div>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data () {
      return {
        ratings: [],
        // data 里面观察 showFlag 的变化
        showFlag: false,
        selectType: ALL,
        onlyContent: true, // 是否只显示内容
        desc: {
          all: '全部',
          positive: '推荐',
          negative: '吐槽'
