    ...
    methods: {
      ...
      pay () {
       ...
       // window.alert(`支付${this.totalPrice}元`)
        ...
        this.$alert(`支付${this.totalPrice}元`)
      }
    },
    components: {
      cartcontrol
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .shopcart
    ...
    .shopcart-list
      ...
      z-index: -1
      width: 100%
      &.foldCartList-enter-active,&.foldCartList-leave-active
        transition all 0.5s
      &.foldCartList-enter,&.foldCartList-leave-active
